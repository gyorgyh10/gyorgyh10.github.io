function osszeadas(e, m) {
    ...
    let elsoSzam = Math.floor(Math.random() * 10000) + 1;
    elso.innerHTML = elsoSzam;
    let masodik = document.querySelector("." + m);
    let masodikSzam = Math.floor(Math.random() * 10000) + 1;
...
function megoldas() {
    ...
    if (eredmeny==5) {
        document.querySelector(".kep").src="pics/uv.jpg"
    }
    if (eredmeny>5) {
        document.querySelector(".kep").src="pics/fejezdBe.jpg"
    }
